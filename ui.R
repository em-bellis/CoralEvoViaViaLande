    ...
    column(3, 
      ...
      selectInput("gen", 
  	  ...
  	  numericInput("G11", 
              ...
              label = "Additive genetic variance, Stressful Environment", value = 0.033, min=0),    


      numericInput("G22", 

                 label = "Additive genetic variance, Refugium Environment", value = 0.001, min=0),
      ...
      numericInput("P22", 
                 ...
                 label = "Phenotypic variance, Refugium Environment (P22)", value = 0.009, min=0),
      ...
      numericInput("zbar2.start", 
                 ...
                 label = "Mean trait value of initial population, Refugium Environment", value = 0.11),
      ...
      numericInput("theta2", 
                 ...
                 label = "Optimal trait value, Refugium Environment", value = 0.1),
      ...
      numericInput("omega2", 
                 ...
                 label = "Strength of stabilizing selection relative to P22, Refugium Environment (smaller=stronger)", value = 3, min=0, max=99)
